...
<!-- Tabel Alternative -->
 ...
 <table border="1" cellspacing="0" width="200" height="200">
  ...
  <?php
  $mahasiswa = $wp->get_data_alternative();
  foreach ($mahasiswa as $data_mahasiswa) {
  ?>
   <tr>
     <td>R<?php echo $data_mahasiswa['id_mahasiswa']; ?></td>
 ...
 <table border="1" cellspacing="0">
   ...
   <tr>
    ...
    <tr>
      <th>R<?php echo $alternative_nilai['id_mahasiswa']; ?></th>
      <?php
      $alternative_nilai_id = $wp->get_data_nilai_id($alternative_nilai['id_mahasiswa']);
...
<table border="1" cellspacing="0" width="1200" height="100">
  ...
  <?php
  $mahasiswa = $wp->get_data_mahasiswa();
  foreach ($mahasiswa as $data_mahasiswa) {
  ?>

  <tr>
    <td rowspan="6"><?php echo $data_mahasiswa['nama_mahasiswa']; ?></td>
  </tr>
  ...
  $index=0;
  $nilai_s=0;
  $data_nilai_id = $wp->get_data_nilai_id($data_mahasiswa['id_mahasiswa']);
  foreach ($data_nilai_id as $data_nilai) {
    ...
    <td>
      ...
      $peringkats['id_mahasiswa']=$data_mahasiswa['id_mahasiswa'];
      $peringkats['nama_mahasiswa']=$data_mahasiswa['nama_mahasiswa'];
...
$no=1;
  ...
  <tr>
    ...
    <td><?php echo $ranking['nama_mahasiswa']; ?></td>
